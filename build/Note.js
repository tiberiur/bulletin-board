var Note = React.createClass({
    ...
    renderForm: function () {
        return React.createElement(
            ...
            { className: 'note',
                style: this.style },
            React.createElement('textarea', { ref: 'newText', defaultValue: this.props.children, className: '', 'form-control': true }),
...
var Board = React.createClass({
    ...
    propTypes: {
        count: function (props, propName) {
            ...
            if (props[propName] > 100) {
                return new Error("Creating " + props[propName] + " notes are ridiculous");
            }
        }
    },
    getInitialState: function () {
    ...
    componentWillMount: function () {
        var self = this;
        if (this.props.count) {
            $.getJSON("http://baconipsum.com/api/?type=all-meat&sentences=" + this.props.count + "&start-width-lorem=1&callback=?", function (results) {
